...
//
//simcpp20::event<SIM_UNIT>
//ByteScheduler::allreduce_one_chunk(simcpp20::simulation<SIM_UNIT> &sim,
//                                   std::priority_queue<Tensor *,
//                                           std::vector<Tensor *>, CustomCompare> &pq) {
...
//
//
//simcpp20::event<SIM_UNIT> ByteScheduler::run_loop(simcpp20::simulation<SIM_UNIT> &sim, unsigned jid) {
//    auto &pq = ready_queue.at(jid);
//    while (!pq.empty() && active_jobs.contains(jid)) {
//        co_await allreduce_one_chunk(sim, pq);
//    }
//}
