...
def plot_timeline(fname, mid=0, from_iter=0, iter_num=1, jid=0, y0=0, height=1, merge_tensor=False, merge_iter=False, plot_this_fp=True, plot_next_fp=False, ax=None, xlim=None, alpha=1):
    ...
    with open(fname) as f:
        lines = [l for l in f if f'mid {mid}' in l]
...
plt, ax = plot_timeline(sys.argv[1], from_iter=0, iter_num=2, jid=1, y0=2, ax=ax, mid=2)
plt.show()